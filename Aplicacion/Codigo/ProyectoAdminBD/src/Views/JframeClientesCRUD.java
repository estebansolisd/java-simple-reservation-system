 ...
 * @author Usuario-pc
 */
public class JframeClientesCRUD extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JframeClientesCRUD
     */
    public JframeClientesCRUD() {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ResultSet resultado;
        try {
            conexion.ejecutarSqlSelect("SELECT * FROM v_clientes");
            resultado = conexion.Fetch();
            TablaClientes.setModel(ConstruirTabla(resultado));
        } catch (Exception e) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (TablaClientes.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaClientes.getValueAt(TablaClientes.getSelectedRow(), 0))));
            Cliente.setInd_cliente(Integer.parseInt(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 0))));
            Cliente.setNum_cedula(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 1)));
            Cliente.setDes_nombre(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 2)));
            Cliente.setDes_direccion(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 3)));
            Cliente.setNom_pais(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 4)));
            Cliente.setNom_distrito(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 5)));
            Cliente.setNom_canton(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 6)));
            Cliente.setNum_telefono(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 7)));
            Cliente.setDes_email(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 8)));
            if (controlador.actualizar_clientes(Cliente)) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Cliente.setInd_cliente(Integer.parseInt(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 0))));
        Cliente.setNum_cedula(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 1)));
        Cliente.setDes_nombre(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 2)));
        Cliente.setDes_direccion(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 3)));
        Cliente.setNom_pais(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 4)));
        Cliente.setNom_distrito(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 5)));
        Cliente.setNom_canton(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 6)));
        Cliente.setNum_telefono(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 7)));
        Cliente.setDes_email(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getModel().getRowCount() - 1, 8)));
        if (controlador.insertar_clientes(Cliente)) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (TablaClientes.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaClientes.getValueAt(TablaClientes.getSelectedRow(), 0))));
            Cliente.setInd_cliente(Integer.parseInt(String.valueOf(TablaClientes.getModel().getValueAt(TablaClientes.getSelectedRow(), 0))));
            if (controlador.eliminar_clientes(Cliente)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeClientesCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeClientesCRUD().setVisible(true);
            }
        });
    }
