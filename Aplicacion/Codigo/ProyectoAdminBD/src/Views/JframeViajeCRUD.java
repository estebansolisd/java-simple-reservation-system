...
import Controller.ViajeControlador;
 ...
 * @author Usuario-pc
 */
public class JframeViajeCRUD extends javax.swing.JFrame {

    DefaultTableModel tabla;
    ViajeModel Viaje = new ViajeModel();
    ViajeControlador controlador = new ViajeControlador();
    Conexion conexion = new Conexion();
    Reserva_ViajeModel Reserva = new Reserva_ViajeModel();
    ArrayList editors = new ArrayList();
    JComboBox comboReservaViaje = new JComboBox();
    DefaultCellEditor editor0 = new DefaultCellEditor(comboReservaViaje);

    /**
     * Creates new form JframeViajesCRUD
     */
    public JframeViajeCRUD() {
    ...
    private void initComponents() {
        ...
        TablaViajes = new javax.swing.JTable(){
            public TableCellEditor getCellEditor(int row, int column)
            {
                ...
                if (modelColumn == 1 && row == TablaViajes.getSelectedRow())
        ...
        setTitle("Mantenimiento de Viajes");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ResultSet resultado;
        try {
            conexion.ejecutarSqlSelect("SELECT * FROM v_viajes");
            resultado = conexion.Fetch();
            TablaViajes.setModel(ConstruirTabla(resultado));
            PonerMascara();
        } catch (Exception e) {
    ...
    public void cargarJComboBox() {
        //Agregamos los editors en el vector para usarlos mas adelante.
        comboReservaViaje.removeAllItems();
        conexion.ejecutarSqlSelect("SELECT * FROM v_viajeReserva");
        editors.add(editor0);
        try {
            ResultSet rs = conexion.Fetch();
            while (rs.next()) {
                comboReservaViaje.addItem(rs.getInt(1));
            }
            rs.close();
        } catch (Exception e) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (TablaViajes.isEditing()) {
            TablaViajes.getCellEditor().stopCellEditing();
        }
        if (TablaViajes.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "Porfavor selecciona la fila que deseas actualizar");
        } else {
            Viaje.setInd_viaje(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 0))));
            Viaje.setInd_re_viaje(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 1))));
            Viaje.setDes_origen(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 2)));
            Viaje.setDes_destino(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 3)));
            Viaje.setFec_salida(Date.valueOf(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 4))));
            Viaje.setFec_llegada(Date.valueOf(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 5))));
            Viaje.setMon_precio(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 6))));
            if (controlador.actualizar_viajes(Viaje)) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Viaje.setInd_viaje(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 0))));
        Viaje.setInd_re_viaje(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 1))));
        Viaje.setDes_origen(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 2)));
        Viaje.setDes_destino(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 3)));
        Viaje.setFec_salida(Date.valueOf(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 4))));
        Viaje.setFec_llegada(Date.valueOf(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 5))));
        Viaje.setMon_precio(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getModel().getRowCount() - 1, 6))));
        if (controlador.insertar_viajes(Viaje)) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (TablaViajes.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaViajes.getValueAt(TablaViajes.getSelectedRow(), 0))));
            Viaje.setInd_viaje(Integer.parseInt(String.valueOf(TablaViajes.getModel().getValueAt(TablaViajes.getSelectedRow(), 0))));
            if (controlador.eliminar_viajes(Viaje)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeViajeCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeViajeCRUD().setVisible(true);
            }
        });
    }
    ...
    public static DefaultTableModel ConstruirTabla(ResultSet rs)
        ...
        columnas.add("Id de viaje");
        columnas.add("Id de reserva");
        columnas.add("Origen");
    ...
    public void PonerMascara() {
        ...
        try {
            ...
            TablaViajes.getColumnModel().getColumn(4).setCellEditor(new DefaultCellEditor(fechaFormateada));
            TablaViajes.getColumnModel().getColumn(5).setCellEditor(new DefaultCellEditor(fechaFormateada));
