...
public class JframeUsuariosCRUD extends javax.swing.JFrame {
    ...
    JComboBox<UsuarioModel> combo = new JComboBox();
    DefaultCellEditor editor = new DefaultCellEditor(combo);

    /**
     * Creates new form JframeUsuariosCRUD
     */
    public JframeUsuariosCRUD() {
        setExtendedState(java.awt.Frame.MAXIMIZED_BOTH);
        initComponents();
        editors.add(editor);
        Usuario.mostrarUsuarios(combo);
        try {
    ...
    private void initComponents() {
        ...
        TablaUsuarios = new javax.swing.JTable(){
            public TableCellEditor getCellEditor(int row, int column)
            {
                ...
                if (modelColumn == 1 && row == TablaUsuarios.getSelectedRow())
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ResultSet resultado;
        try {
            conexion.ejecutarSqlSelect("SELECT * FROM v_usuarios");
            resultado = conexion.Fetch();
            TablaUsuarios.setModel(ConstruirTabla(resultado));
        } catch (Exception e) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (TablaUsuarios.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaUsuarios.getValueAt(TablaUsuarios.getSelectedRow(), 0))));
            Usuario.setInd_usuario(Integer.parseInt(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getSelectedRow(), 0))));
            Usuario.setInd_empleado(combo.getItemAt(combo.getSelectedIndex()).getInd_empleado());
            Usuario.setLog_usuario(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getSelectedRow(), 2)));
            Usuario.setDes_clave(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getSelectedRow(), 3)));
            Usuario.setInd_tipo(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getSelectedRow(), 4)));
            if (controlador.actualizar_usuarios(Usuario)) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            Usuario.setInd_usuario(Integer.parseInt(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getModel().getRowCount() - 1, 0))));
            Usuario.setInd_empleado(combo.getItemAt(combo.getSelectedIndex()).getInd_empleado());
            Usuario.setLog_usuario(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getModel().getRowCount() - 1, 2)));
            Usuario.setDes_clave(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getModel().getRowCount() - 1, 3)));
            Usuario.setInd_tipo(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getModel().getRowCount() - 1, 4)));
            if (controlador.insertar_usuarios(Usuario)) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            if (TablaUsuarios.getSelectedRow() == -1) {
                ...
                //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaUsuarios.getValueAt(TablaUsuarios.getSelectedRow(), 0))));
                Usuario.setInd_usuario(Integer.parseInt(String.valueOf(TablaUsuarios.getModel().getValueAt(TablaUsuarios.getSelectedRow(), 0))));
                if (controlador.eliminar_usuarios(Usuario)) {
     ...
     * JComboBox(vector);
     * TablaUsuarios.getColumnModel().getColumn(1).setCellEditor(new
    ...
    public static DefaultTableModel ConstruirTabla(ResultSet rs)
        ...
        columnas.add("Número de Identificación de Usuario");
        columnas.add("Nombre del Empleado");
        columnas.add("Nombre de Usuario");
        columnas.add("Clave de Usuario");
