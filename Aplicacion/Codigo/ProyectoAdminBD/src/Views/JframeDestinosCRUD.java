...
import Controller.DestinoControlador;
 ...
 * @author Usuario-pc
 */
public class JframeDestinosCRUD extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JframeDestinosCRUD
     */
    public JframeDestinosCRUD() {
        ...
        try {
            if (WinRegistry.readString(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\JAVAPROYECTO", "User").equals("jose")) {
                ...
                TablaDestinos.setEnabled(false);
            }
        } catch (Exception ex) {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ResultSet resultado;
        try {
            conexion.ejecutarSqlSelect("SELECT * FROM v_destinos");
            resultado = conexion.Fetch();
            TablaDestinos.setModel(ConstruirTabla(resultado));
        } catch (Exception e) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (TablaDestinos.isEditing()) {
            TablaDestinos.getCellEditor().stopCellEditing();
        }
        if (TablaDestinos.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaDestinos.getValueAt(TablaDestinos.getSelectedRow(), 0))));
            Destino.setInd_destino(Integer.parseInt(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getSelectedRow(), 0))));
            Destino.setDes_destino(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getSelectedRow(), 1)));
            Destino.setDes_observacion(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getSelectedRow(), 2)));
            Destino.setMon_precio(Integer.parseInt(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getSelectedRow(), 3))));
            if (controlador.actualizar_destinos(Destino)) {
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        DefaultTableModel modelo = (DefaultTableModel) TablaDestinos.getModel();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaDestinos.getValueAt(TablaDestinos.getSelectedRow(), 0))));
        Destino.setInd_destino(Integer.parseInt(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getRowCount() - 1, 0))));
        Destino.setDes_destino(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getRowCount() - 1, 1)));
        Destino.setDes_observacion(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getRowCount() - 1, 2)));
        Destino.setMon_precio(Integer.parseInt(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getRowCount() - 1, 3))));
        if (controlador.insertar_destinos(Destino)) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (TablaDestinos.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaDestinos.getValueAt(TablaDestinos.getSelectedRow(), 0))));
            Destino.setInd_destino(Integer.parseInt(String.valueOf(TablaDestinos.getModel().getValueAt(TablaDestinos.getSelectedRow(), 0))));
            if (controlador.eliminar_destinos(Destino)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeDestinosCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeDestinosCRUD().setVisible(true);
            }
        });
    }
