...
import Controller.TransporteControlador;
 ...
 * @author Usuario-pc
 */
public class JframeTransportesCRUD extends javax.swing.JFrame {

    DefaultTableModel tabla;
    TransporteModel Transporte = new TransporteModel();
    TransporteControlador controlador = new TransporteControlador();
    Conexion conexion = new Conexion();

    /**
     * Creates new form JframeTransportesCRUD
     */
    public JframeTransportesCRUD() {
        ...
        try {
            if (WinRegistry.readString(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\JAVAPROYECTO", "User").equals("jose")) {
                ...
                TablaTransportes.setEnabled(false);
            }
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento de Transportes");
        ...
        TablaTransportes.setRowHeight(25);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ResultSet resultado;
        try {
            conexion.ejecutarSqlSelect("SELECT * FROM v_transportes");
            resultado = conexion.Fetch();
            TablaTransportes.setModel(ConstruirTabla(resultado));
            PonerMascara();
        } catch (Exception e) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (TablaTransportes.isEditing()) {
            TablaTransportes.getCellEditor().stopCellEditing();
        }
        if (TablaTransportes.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "Porfavor selecciona la fila que deseas actualizar");
        } else {
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaTransportes.getValueAt(TablaTransportes.getSelectedRow(), 0))));
            Transporte.setInd_transporte(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 0))));
            Transporte.setTip_transporte(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 1)));
            Transporte.setDes_origen(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 2)));
            Transporte.setDes_destino(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 3)));
            Transporte.setFec_salida(Date.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 4))));
            Transporte.setHor_salida(Time.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 5))));
            Transporte.setFec_llegada(Date.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 6))));
            Transporte.setHor_llegada(Time.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 7))));
            Transporte.setNum_plazas(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 8))));
            Transporte.setMon_precio(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 9))));
            if (controlador.actualizar_transportes(Transporte)) {
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        DefaultTableModel modelo = (DefaultTableModel) TablaTransportes.getModel();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Transporte.setInd_transporte(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 0))));
        Transporte.setTip_transporte(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 1)));
        Transporte.setDes_origen(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 2)));
        Transporte.setDes_destino(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 3)));
        Transporte.setFec_salida(Date.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 4))));
        Transporte.setHor_salida(Time.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 5))));
        Transporte.setFec_llegada(Date.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 6))));
        Transporte.setHor_llegada(Time.valueOf(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 7))));
        Transporte.setNum_plazas(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 8))));
        Transporte.setMon_precio(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getModel().getRowCount() - 1, 9))));

        if (controlador.insertar_transportes(Transporte)) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (TablaTransportes.getSelectedRow() == -1) {
            ...
            //JOptionPane.showMessageDialog(rootPane, Integer.parseInt(String.valueOf(TablaTransportes.getValueAt(TablaTransportes.getSelectedRow(), 0))));
            Transporte.setInd_transporte(Integer.parseInt(String.valueOf(TablaTransportes.getModel().getValueAt(TablaTransportes.getSelectedRow(), 0))));
            if (controlador.eliminar_transportes(Transporte)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeTransportesCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeTransportesCRUD().setVisible(true);
            }
        });
    }
    ...
    public static DefaultTableModel ConstruirTabla(ResultSet rs)
        ...
        columnas.add("Hora de Salida");
        columnas.add("Fecha de Llegada");
        columnas.add("Hora de Llegada");
        columnas.add("Numero de Plazas");
        columnas.add("Precio");
        /**
    ...
    public void PonerMascara() {
        ...
        try {
            ...
            MaskFormatter mascaraH = new MaskFormatter("##:##:##");
            JFormattedTextField horaFormateada = new JFormattedTextField(mascaraH);
            horaFormateada.setToolTipText("hh:mm:ss");
            TablaTransportes.getColumnModel().getColumn(4).setCellEditor(new DefaultCellEditor(fechaFormateada));
            TablaTransportes.getColumnModel().getColumn(5).setCellEditor(new DefaultCellEditor(horaFormateada));
            TablaTransportes.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(fechaFormateada));
            TablaTransportes.getColumnModel().getColumn(7).setCellEditor(new DefaultCellEditor(horaFormateada));
